...
<body>
    ...
    <pre class="codiad">&lt;input type=&quot;text&quot;&gt;
...
&lt;textarea&gt;&lt;/textarea&gt;</pre>
    ...
    <pre class="codiad">&lt;button &gt;Left Button&lt;/button&gt;&lt;button &gt;Mid Button&lt;/button&gt;&lt;button &gt;Right Button&lt;/button&gt;</pre>
    
    <p>Output:</p>
    
    <button>Left Button</button><button>Mid Button</button><button>Right Button</button>
