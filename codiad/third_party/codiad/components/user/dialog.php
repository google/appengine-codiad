    ...
    */
    ...
    switch($_GET['action']){
        ...
        case 'list':
            ...
            <button class="codiad " onclick="codiad.user.createNew();"><?php i18n("New Account"); ?></button>
    		<button class="codiad " onclick="codiad.modal.unload();return false;"><?php i18n("Close"); ?></button>
            <?php
            }
        ...
        case 'create':
            ...
            <button class="codiad "><?php i18n("Create Account"); ?></button>
			<button class="codiad " onclick="codiad.user.list();return false;"><?php i18n("Cancel"); ?></button>
            </form>
            <?php
            break;
        ...
        ?>
            ...
            <select class="codiad" name="access_level" onchange="if($(this).val()=='0'){ $('#project-selector').slideUp(300); }else{ $('#project-selector').slideDown(300).css({'overflow-y':'scroll'}); }">
            ...
            <button class="codiad "><?php i18n("Confirm"); ?></button>
			<button class="codiad " onclick="codiad.user.list();return false;"><?php i18n("Close"); ?></button></form>
            <?php
            break;
        ...
        ?>
            ...
            <button class="codiad "><?php i18n("Confirm"); ?></button>
			<button class="codiad " onclick="codiad.user.list();return false;"><?php i18n("Cancel"); ?></button></form>
            <?php
            break;
        ...
        ?>
            ...
            <label><?php i18n("Confirm Password"); ?></label>
            <input type="password" name="password2">
          <button class="codiad"><?php i18n("Change %{username}%&apos;s Password", array("username" => ucfirst($username))) ?></button>
			<button class="codiad" onclick="codiad.modal.unload();return false;"><?php i18n("Cancel"); ?></button></form>
            <?php
            break;
